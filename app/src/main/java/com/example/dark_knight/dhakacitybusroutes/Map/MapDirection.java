...
public class MapDirection {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyBvwzf9ABA4XCq4Mq8LjZ8PkyWvk-Q3SV0";
    ...
    public MapDirection(Context context, String startingLocationString, String endingLocationString) {
